...
const speakers = [
  {
    name: "Mr. Raghvendra Mishra",
    description: "Lalbaba Engineering Limited",
    img: "speakers/RaghvendraKumar.jpeg",
  },
  {
    name: "Mr. Naba Kumar Koner",
    description: "Chief General Manager(L.P.G), Eastern Zone, at Indian Oil Corporation Limited",
    img: "",
  },
  {
    name: "Mr. Surjeet Kumar",
    description: "Co-Founder & Director, of Agastya Invention Private Limited",
    img: "speakers/SurjeetKumar.jpeg",
  },
  {
    name: "Mr. Rahul Gosh",
    description: "Senior Manager, at Maruti Suzuki India Limited",
    img: "speakers/RahulGosh.jpeg",
  },
  {
    name: "Dr. Asim Ghosal",
    description: "Consulting Engineer, at GE Aerospace",
    img: "speakers/AsimK.jpeg",
  },
  {
    name: "Mr. Manish Kumar Jha",
    description: "Deputy General Manager, at Power Finance Corporation Limited",
    img: "",
  },
  {
    name: "Mr. Deepayan Kumar Jha",
    description: "Managing Director, at Mahr Metrology India Private Limited",
    img: "speakers/DeepayanDas.jpeg",
  },
];
    ...
    "
          ...
          <div className="relative z-10 mx-auto mt-8 max-w-screen-xl px-6 pt-16 flex flex-col gap-10">
            ...
            <div>
              ...
              >
                The Industrial Academia Meet in IMPETUS is designed to establish
                a collaborative platform for meaningful engagement between
                industry and academia. This initiative emphasizes the exchange
                of knowledge and innovative ideas, fostering thought-provoking
                discussions around best practices, employability trends across
                diverse engineering domains, and strategies to identify and
                nurture talent during campus recruitment. It also seeks to
                bridge the gap between academic learning and industrial
                expectations, ensuring students are equipped with real-world
                insights and skills. With a lineup of esteemed speakers from
                leading industries, this event promises to be a treasure trove
                of wisdom and inspiration. Get ready to meet the visionaries who
                will ignite your curiosity and redefine your perspective!
              </p>
            </div>
            ...
            <div>
              ...
              >
                ...
                Industry-Academia Meet, bringing together leading industry
                experts and renowned academicians to share their insights,
            ...
            {/* Timelines Section */}
            <div className="flex flex-col md:flex-row justify-center gap-50 md:gap-[175px]">
